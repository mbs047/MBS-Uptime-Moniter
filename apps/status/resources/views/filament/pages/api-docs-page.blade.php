        ...
        >
            <div style="display: grid; gap: 1rem; grid-template-columns: minmax(0, 1fr);">
                @foreach ($endpointCatalog['public'] as $endpoint)
                    ...
                    <div
                        x-data="{ open: {{ $response ? 'true' : 'false' }} }"
                        style="
                            display: grid;
                            gap: 1rem;
                            padding: 1rem;
                    ...
                    >
                        <div style="display: flex; justify-content: space-between; gap: 0.75rem; align-items: flex-start; flex-wrap: wrap;">
                            ...
                            <div style="display: flex; flex-wrap: wrap; gap: 0.6rem; align-items: center;">
                                <button
                                    ...
                                    "
                                >
                                    <span x-cloak x-show="! open">Show details</span>
                                    <span x-cloak x-show="open">Hide details</span>
                                </button>
                        ...
                        <div x-cloak x-show="open" style="display: grid; gap: 1rem;">
